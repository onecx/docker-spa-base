...
ENV CONFIG_ENV_LIST BFF_URL,APP_BASE_HREF,CORS_ENABLED,CORS_ALLOW_ORIGIN,CORS_ALLOW_REGEX,CORS_ALLOW_CREDENTIALS,CORS_ALLOW_HEADERS,CORS_ALLOW_METHODS,APP_VERSION,APP_ID,PRODUCT_NAME,TKIT_PORTAL_URL
